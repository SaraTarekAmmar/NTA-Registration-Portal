...
from routers import admin, courses, chat, ai_services, exams, class_matrix, quiz_results, tickets, front_signups, safe_reviews
...
app.include_router(front_signups.router)

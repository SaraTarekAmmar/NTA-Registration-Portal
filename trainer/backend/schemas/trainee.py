...
class TraineeUpdate(BaseModel):
    ...
    nativeLanguage: Optional[str] = None
    englishProficiency: Optional[str] = None
    militaryStatus: Optional[str] = None
    militaryReason: Optional[str] = None
    academicHistory: Optional[List[Any]] = None
    professionalHistory: Optional[List[Any]] = None
    technicalSkills: Optional[List[Any]] = None
    softSkills: Optional[List[Any]] = None
    computerSkills: Optional[List[Any]] = None
    yearsExperience: Optional[int] = None
    objective: Optional[str] = None
    portfolioUrl: Optional[str] = None

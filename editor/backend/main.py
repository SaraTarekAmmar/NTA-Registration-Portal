...
from routers import auth as auth_router, courses, course_save, materials, sessions, flow_builder, tickets, front_manager, interview_templates
...
app.include_router(interview_templates.router)
